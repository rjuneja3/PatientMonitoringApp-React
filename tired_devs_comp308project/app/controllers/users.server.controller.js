    ...
    if (!user) {//if user is not found for corresponding email address
      ...
      if (bcrypt.compareSync(password, user.password)) {
        ...
        const token = jwt.sign(
          { id: user._id, username: user.username, userRole: user.userRole, user: user },
          jwtKey,
...
exports.isSignedIn = (req, res) => {
  ...
  res
    .status(200)
    .send({id: payload.user._id, loggedIn: true, username: payload.username, user: payload.user, userRole: payload.userRole });
};
